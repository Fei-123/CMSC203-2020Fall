...
public class HolidayBonusTest {
	...
	public void tearDown() throws Exception {
		...
		public void testCalculateHolidayBonusA() {
			...
			assertEquals(6000.0,result[2],.001);
		...
		public void testCalculateHolidayBonusB() {
			...
			assertEquals(1250.0,result[2],.001);
	...
	public void testCalculateTotalHolidayBonusA() {
		...
		assertEquals(31000.0,HolidayBonus.calculateTotalHolidayBonus(dataSet4, 5000, 1000, 2000),.001);
	...
	public void testCalculateTotalHolidayBonusB() {
		...
		assertEquals(6750.0,HolidayBonus.calculateTotalHolidayBonus(dataSet4, 1000,250,500),.001);
