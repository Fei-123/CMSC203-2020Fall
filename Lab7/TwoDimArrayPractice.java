...
private int minimum =0;
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  and column is the index of the array's current column
    // Write your code here:
 for(int row1 = 0 ; row1 <= rowSelected; row1 ++) {
		   
		   for(int column = 0; column < intArray[row1].length; column ++) {
			  
			   Arrays.fill(intArray[rowSelected], key);
			   animate(row1,column);
   ...
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   for(int row1 = 0 ; row1 < intArray.length; row1 ++) {
		   minimum  = intArray[0][columnSelected];
		   for(int column1 = 0; column1 < intArray[row1].length; column1 ++) {
			  
			   if (intArray[row1][columnSelected] < minimum ) {
				   minimum = intArray[row1][columnSelected];
			   }
			   animate(row1,column,minimum);
